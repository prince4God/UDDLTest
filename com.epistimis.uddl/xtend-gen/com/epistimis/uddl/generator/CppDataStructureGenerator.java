...
public class CppDataStructureGenerator extends CommonDataStructureGenerator {
  public CppDataStructureGenerator(final Map<PlatformComposableElement, RealizedComposableElement> ace) {
    super(ace);
  }

  public CppDataStructureGenerator() {
    super();
    this.initialize();
  }
